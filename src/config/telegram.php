...
return [
    ...
    'bots' => [
        'mybot' => [
            'token' => env('TELEGRAM_BOT_TOKEN', default: '7791381824:AAFHE-4VeR4M_jO1d0B8ZHu3AKGL9JHs6jM'),
            'certificate_path' => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url' => env('TELEGRAM_WEBHOOK_URL', 'https://sadr-daneshir.ir/telegram/webhook'),
